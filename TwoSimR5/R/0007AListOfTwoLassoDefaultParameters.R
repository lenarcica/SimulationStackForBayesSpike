###############################################################################
##  0007AListOfTwoLassoDefaultParameters.r  -- Alan Lenarcic
##
##    01-09-2019
##
##   Saves a few default variable settings to Global Environment which are
##   often over-written for any given simulation.
##
##
##   
