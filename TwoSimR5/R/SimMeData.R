...
##
##  Simulator functions for Fixed Parameter Beta and Grouped Parameter Beta data
##   and values. 
##
##  SimMeData has to generate covariates X and noise to produce Y.
##   "Beta" has random placement non-zero Beta values throughout length p vector
##
