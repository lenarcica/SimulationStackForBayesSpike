...
/*                                                                            */
/*   This code adapts LarsObject.cc and .h are a implementation of LARS by    */
/* and tries to compare 2 Lasso operations with EM indicators creating a      */
/* "Weighted LARS" implementation that is iterated with EM.                   */
/* ========================================================================== */
/******************************************************************************/
//// LICENSE INFO: C CODE
